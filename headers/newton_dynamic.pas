...
begin
	...
	NewtonLibrary := dynlibs.LoadLibrary(dllpath);
	linked_functions[0].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetVersion');
	NewtonWorldGetVersion:= linked_functions[0].function_ptr;
	linked_functions[1].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldFloatSize');
	NewtonWorldFloatSize:= linked_functions[1].function_ptr;
	linked_functions[2].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetMemoryUsed');
	NewtonGetMemoryUsed:= linked_functions[2].function_ptr;
	linked_functions[3].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetMemorySystem');
	NewtonSetMemorySystem:= linked_functions[3].function_ptr;
	linked_functions[4].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreate');
	NewtonCreate:= linked_functions[4].function_ptr;
	linked_functions[5].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDestroy');
	NewtonDestroy:= linked_functions[5].function_ptr;
	linked_functions[6].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDestroyAllBodies');
	NewtonDestroyAllBodies:= linked_functions[6].function_ptr;
	linked_functions[7].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetPostUpdateCallback');
	NewtonGetPostUpdateCallback:= linked_functions[7].function_ptr;
	linked_functions[8].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetPostUpdateCallback');
	NewtonSetPostUpdateCallback:= linked_functions[8].function_ptr;
	linked_functions[9].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonAlloc');
	NewtonAlloc:= linked_functions[9].function_ptr;
	linked_functions[10].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFree');
	NewtonFree:= linked_functions[10].function_ptr;
	linked_functions[11].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonLoadPlugins');
	NewtonLoadPlugins:= linked_functions[11].function_ptr;
	linked_functions[12].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUnloadPlugins');
	NewtonUnloadPlugins:= linked_functions[12].function_ptr;
	linked_functions[13].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCurrentPlugin');
	NewtonCurrentPlugin:= linked_functions[13].function_ptr;
	linked_functions[14].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetFirstPlugin');
	NewtonGetFirstPlugin:= linked_functions[14].function_ptr;
	linked_functions[15].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetPreferedPlugin');
	NewtonGetPreferedPlugin:= linked_functions[15].function_ptr;
	linked_functions[16].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetNextPlugin');
	NewtonGetNextPlugin:= linked_functions[16].function_ptr;
	linked_functions[17].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetPluginString');
	NewtonGetPluginString:= linked_functions[17].function_ptr;
	linked_functions[18].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSelectPlugin');
	NewtonSelectPlugin:= linked_functions[18].function_ptr;
	linked_functions[19].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetContactMergeTolerance');
	NewtonGetContactMergeTolerance:= linked_functions[19].function_ptr;
	linked_functions[20].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetContactMergeTolerance');
	NewtonSetContactMergeTolerance:= linked_functions[20].function_ptr;
	linked_functions[21].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonInvalidateCache');
	NewtonInvalidateCache:= linked_functions[21].function_ptr;
	linked_functions[22].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetSolverIterations');
	NewtonSetSolverIterations:= linked_functions[22].function_ptr;
	linked_functions[23].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetSolverIterations');
	NewtonGetSolverIterations:= linked_functions[23].function_ptr;
	linked_functions[24].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetParallelSolverOnLargeIsland');
	NewtonSetParallelSolverOnLargeIsland:= linked_functions[24].function_ptr;
	linked_functions[25].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetParallelSolverOnLargeIsland');
	NewtonGetParallelSolverOnLargeIsland:= linked_functions[25].function_ptr;
	linked_functions[26].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetBroadphaseAlgorithm');
	NewtonGetBroadphaseAlgorithm:= linked_functions[26].function_ptr;
	linked_functions[27].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSelectBroadphaseAlgorithm');
	NewtonSelectBroadphaseAlgorithm:= linked_functions[27].function_ptr;
	linked_functions[28].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonResetBroadphase');
	NewtonResetBroadphase:= linked_functions[28].function_ptr;
	linked_functions[29].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUpdate');
	NewtonUpdate:= linked_functions[29].function_ptr;
	linked_functions[30].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUpdateAsync');
	NewtonUpdateAsync:= linked_functions[30].function_ptr;
	linked_functions[31].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWaitForUpdateToFinish');
	NewtonWaitForUpdateToFinish:= linked_functions[31].function_ptr;
	linked_functions[32].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetNumberOfSubsteps');
	NewtonGetNumberOfSubsteps:= linked_functions[32].function_ptr;
	linked_functions[33].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetNumberOfSubsteps');
	NewtonSetNumberOfSubsteps:= linked_functions[33].function_ptr;
	linked_functions[34].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetLastUpdateTime');
	NewtonGetLastUpdateTime:= linked_functions[34].function_ptr;
	linked_functions[35].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSerializeToFile');
	NewtonSerializeToFile:= linked_functions[35].function_ptr;
	linked_functions[36].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDeserializeFromFile');
	NewtonDeserializeFromFile:= linked_functions[36].function_ptr;
	linked_functions[37].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSerializeScene');
	NewtonSerializeScene:= linked_functions[37].function_ptr;
	linked_functions[38].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDeserializeScene');
	NewtonDeserializeScene:= linked_functions[38].function_ptr;
	linked_functions[39].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFindSerializedBody');
	NewtonFindSerializedBody:= linked_functions[39].function_ptr;
	linked_functions[40].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetJointSerializationCallbacks');
	NewtonSetJointSerializationCallbacks:= linked_functions[40].function_ptr;
	linked_functions[41].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetJointSerializationCallbacks');
	NewtonGetJointSerializationCallbacks:= linked_functions[41].function_ptr;
	linked_functions[42].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldCriticalSectionLock');
	NewtonWorldCriticalSectionLock:= linked_functions[42].function_ptr;
	linked_functions[43].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldCriticalSectionUnlock');
	NewtonWorldCriticalSectionUnlock:= linked_functions[43].function_ptr;
	linked_functions[44].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetThreadsCount');
	NewtonSetThreadsCount:= linked_functions[44].function_ptr;
	linked_functions[45].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetThreadsCount');
	NewtonGetThreadsCount:= linked_functions[45].function_ptr;
	linked_functions[46].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetMaxThreadsCount');
	NewtonGetMaxThreadsCount:= linked_functions[46].function_ptr;
	linked_functions[47].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDispachThreadJob');
	NewtonDispachThreadJob:= linked_functions[47].function_ptr;
	linked_functions[48].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSyncThreadJobs');
	NewtonSyncThreadJobs:= linked_functions[48].function_ptr;
	linked_functions[49].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonAtomicAdd');
	NewtonAtomicAdd:= linked_functions[49].function_ptr;
	linked_functions[50].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonAtomicSwap');
	NewtonAtomicSwap:= linked_functions[50].function_ptr;
	linked_functions[51].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonYield');
	NewtonYield:= linked_functions[51].function_ptr;
	linked_functions[52].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetIslandUpdateEvent');
	NewtonSetIslandUpdateEvent:= linked_functions[52].function_ptr;
	linked_functions[53].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldForEachJointDo');
	NewtonWorldForEachJointDo:= linked_functions[53].function_ptr;
	linked_functions[54].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldForEachBodyInAABBDo');
	NewtonWorldForEachBodyInAABBDo:= linked_functions[54].function_ptr;
	linked_functions[55].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldSetUserData');
	NewtonWorldSetUserData:= linked_functions[55].function_ptr;
	linked_functions[56].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetUserData');
	NewtonWorldGetUserData:= linked_functions[56].function_ptr;
	linked_functions[57].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldAddListener');
	NewtonWorldAddListener:= linked_functions[57].function_ptr;
	linked_functions[58].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetListener');
	NewtonWorldGetListener:= linked_functions[58].function_ptr;
	linked_functions[59].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldListenerSetDebugCallback');
	NewtonWorldListenerSetDebugCallback:= linked_functions[59].function_ptr;
	linked_functions[60].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldListenerSetPostStepCallback');
	NewtonWorldListenerSetPostStepCallback:= linked_functions[60].function_ptr;
	linked_functions[61].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldListenerSetPreUpdateCallback');
	NewtonWorldListenerSetPreUpdateCallback:= linked_functions[61].function_ptr;
	linked_functions[62].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldListenerSetPostUpdateCallback');
	NewtonWorldListenerSetPostUpdateCallback:= linked_functions[62].function_ptr;
	linked_functions[63].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldListenerSetDestructorCallback');
	NewtonWorldListenerSetDestructorCallback:= linked_functions[63].function_ptr;
	linked_functions[64].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldListenerSetBodyDestroyCallback');
	NewtonWorldListenerSetBodyDestroyCallback:= linked_functions[64].function_ptr;
	linked_functions[65].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldListenerDebug');
	NewtonWorldListenerDebug:= linked_functions[65].function_ptr;
	linked_functions[66].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetListenerUserData');
	NewtonWorldGetListenerUserData:= linked_functions[66].function_ptr;
	linked_functions[67].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldListenerGetBodyDestroyCallback');
	NewtonWorldListenerGetBodyDestroyCallback:= linked_functions[67].function_ptr;
	linked_functions[68].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldSetDestructorCallback');
	NewtonWorldSetDestructorCallback:= linked_functions[68].function_ptr;
	linked_functions[69].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetDestructorCallback');
	NewtonWorldGetDestructorCallback:= linked_functions[69].function_ptr;
	linked_functions[70].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldSetCollisionConstructorDestructorCallback');
	NewtonWorldSetCollisionConstructorDestructorCallback:= linked_functions[70].function_ptr;
	linked_functions[71].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldSetCreateDestroyContactCallback');
	NewtonWorldSetCreateDestroyContactCallback:= linked_functions[71].function_ptr;
	linked_functions[72].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldRayCast');
	NewtonWorldRayCast:= linked_functions[72].function_ptr;
	linked_functions[73].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldConvexCast');
	NewtonWorldConvexCast:= linked_functions[73].function_ptr;
	linked_functions[74].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldCollide');
	NewtonWorldCollide:= linked_functions[74].function_ptr;
	linked_functions[75].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetBodyCount');
	NewtonWorldGetBodyCount:= linked_functions[75].function_ptr;
	linked_functions[76].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetConstraintCount');
	NewtonWorldGetConstraintCount:= linked_functions[76].function_ptr;
	linked_functions[77].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldFindJoint');
	NewtonWorldFindJoint:= linked_functions[77].function_ptr;
	linked_functions[78].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonIslandGetBody');
	NewtonIslandGetBody:= linked_functions[78].function_ptr;
	linked_functions[79].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonIslandGetBodyAABB');
	NewtonIslandGetBodyAABB:= linked_functions[79].function_ptr;
	linked_functions[80].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialCreateGroupID');
	NewtonMaterialCreateGroupID:= linked_functions[80].function_ptr;
	linked_functions[81].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetDefaultGroupID');
	NewtonMaterialGetDefaultGroupID:= linked_functions[81].function_ptr;
	linked_functions[82].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialDestroyAllGroupID');
	NewtonMaterialDestroyAllGroupID:= linked_functions[82].function_ptr;
	linked_functions[83].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetUserData');
	NewtonMaterialGetUserData:= linked_functions[83].function_ptr;
	linked_functions[84].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetSurfaceThickness');
	NewtonMaterialSetSurfaceThickness:= linked_functions[84].function_ptr;
	linked_functions[85].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetCallbackUserData');
	NewtonMaterialSetCallbackUserData:= linked_functions[85].function_ptr;
	linked_functions[86].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactGenerationCallback');
	NewtonMaterialSetContactGenerationCallback:= linked_functions[86].function_ptr;
	linked_functions[87].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetCompoundCollisionCallback');
	NewtonMaterialSetCompoundCollisionCallback:= linked_functions[87].function_ptr;
	linked_functions[88].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetCollisionCallback');
	NewtonMaterialSetCollisionCallback:= linked_functions[88].function_ptr;
	linked_functions[89].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetDefaultSoftness');
	NewtonMaterialSetDefaultSoftness:= linked_functions[89].function_ptr;
	linked_functions[90].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetDefaultElasticity');
	NewtonMaterialSetDefaultElasticity:= linked_functions[90].function_ptr;
	linked_functions[91].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetDefaultCollidable');
	NewtonMaterialSetDefaultCollidable:= linked_functions[91].function_ptr;
	linked_functions[92].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetDefaultFriction');
	NewtonMaterialSetDefaultFriction:= linked_functions[92].function_ptr;
	linked_functions[93].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialJointResetIntraJointCollision');
	NewtonMaterialJointResetIntraJointCollision:= linked_functions[93].function_ptr;
	linked_functions[94].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialJointResetSelftJointCollision');
	NewtonMaterialJointResetSelftJointCollision:= linked_functions[94].function_ptr;
	linked_functions[95].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetFirstMaterial');
	NewtonWorldGetFirstMaterial:= linked_functions[95].function_ptr;
	linked_functions[96].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetNextMaterial');
	NewtonWorldGetNextMaterial:= linked_functions[96].function_ptr;
	linked_functions[97].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetFirstBody');
	NewtonWorldGetFirstBody:= linked_functions[97].function_ptr;
	linked_functions[98].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonWorldGetNextBody');
	NewtonWorldGetNextBody:= linked_functions[98].function_ptr;
	linked_functions[99].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetMaterialPairUserData');
	NewtonMaterialGetMaterialPairUserData:= linked_functions[99].function_ptr;
	linked_functions[100].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactFaceAttribute');
	NewtonMaterialGetContactFaceAttribute:= linked_functions[100].function_ptr;
	linked_functions[101].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetBodyCollidingShape');
	NewtonMaterialGetBodyCollidingShape:= linked_functions[101].function_ptr;
	linked_functions[102].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactNormalSpeed');
	NewtonMaterialGetContactNormalSpeed:= linked_functions[102].function_ptr;
	linked_functions[103].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactForce');
	NewtonMaterialGetContactForce:= linked_functions[103].function_ptr;
	linked_functions[104].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactPositionAndNormal');
	NewtonMaterialGetContactPositionAndNormal:= linked_functions[104].function_ptr;
	linked_functions[105].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactTangentDirections');
	NewtonMaterialGetContactTangentDirections:= linked_functions[105].function_ptr;
	linked_functions[106].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactTangentSpeed');
	NewtonMaterialGetContactTangentSpeed:= linked_functions[106].function_ptr;
	linked_functions[107].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactMaxNormalImpact');
	NewtonMaterialGetContactMaxNormalImpact:= linked_functions[107].function_ptr;
	linked_functions[108].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactMaxTangentImpact');
	NewtonMaterialGetContactMaxTangentImpact:= linked_functions[108].function_ptr;
	linked_functions[109].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactPenetration');
	NewtonMaterialGetContactPenetration:= linked_functions[109].function_ptr;
	linked_functions[110].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetAsSoftContact');
	NewtonMaterialSetAsSoftContact:= linked_functions[110].function_ptr;
	linked_functions[111].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactSoftness');
	NewtonMaterialSetContactSoftness:= linked_functions[111].function_ptr;
	linked_functions[112].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactThickness');
	NewtonMaterialSetContactThickness:= linked_functions[112].function_ptr;
	linked_functions[113].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactElasticity');
	NewtonMaterialSetContactElasticity:= linked_functions[113].function_ptr;
	linked_functions[114].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactFrictionState');
	NewtonMaterialSetContactFrictionState:= linked_functions[114].function_ptr;
	linked_functions[115].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactFrictionCoef');
	NewtonMaterialSetContactFrictionCoef:= linked_functions[115].function_ptr;
	linked_functions[116].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactNormalAcceleration');
	NewtonMaterialSetContactNormalAcceleration:= linked_functions[116].function_ptr;
	linked_functions[117].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactNormalDirection');
	NewtonMaterialSetContactNormalDirection:= linked_functions[117].function_ptr;
	linked_functions[118].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactPosition');
	NewtonMaterialSetContactPosition:= linked_functions[118].function_ptr;
	linked_functions[119].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactTangentFriction');
	NewtonMaterialSetContactTangentFriction:= linked_functions[119].function_ptr;
	linked_functions[120].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactTangentAcceleration');
	NewtonMaterialSetContactTangentAcceleration:= linked_functions[120].function_ptr;
	linked_functions[121].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialContactRotateTangentDirections');
	NewtonMaterialContactRotateTangentDirections:= linked_functions[121].function_ptr;
	linked_functions[122].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialGetContactPruningTolerance');
	NewtonMaterialGetContactPruningTolerance:= linked_functions[122].function_ptr;
	linked_functions[123].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonMaterialSetContactPruningTolerance');
	NewtonMaterialSetContactPruningTolerance:= linked_functions[123].function_ptr;
	linked_functions[124].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateNull');
	NewtonCreateNull:= linked_functions[124].function_ptr;
	linked_functions[125].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateSphere');
	NewtonCreateSphere:= linked_functions[125].function_ptr;
	linked_functions[126].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateBox');
	NewtonCreateBox:= linked_functions[126].function_ptr;
	linked_functions[127].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateCone');
	NewtonCreateCone:= linked_functions[127].function_ptr;
	linked_functions[128].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateCapsule');
	NewtonCreateCapsule:= linked_functions[128].function_ptr;
	linked_functions[129].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateCylinder');
	NewtonCreateCylinder:= linked_functions[129].function_ptr;
	linked_functions[130].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateChamferCylinder');
	NewtonCreateChamferCylinder:= linked_functions[130].function_ptr;
	linked_functions[131].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateConvexHull');
	NewtonCreateConvexHull:= linked_functions[131].function_ptr;
	linked_functions[132].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateConvexHullFromMesh');
	NewtonCreateConvexHullFromMesh:= linked_functions[132].function_ptr;
	linked_functions[133].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetMode');
	NewtonCollisionGetMode:= linked_functions[133].function_ptr;
	linked_functions[134].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSetMode');
	NewtonCollisionSetMode:= linked_functions[134].function_ptr;
	linked_functions[135].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConvexHullGetFaceIndices');
	NewtonConvexHullGetFaceIndices:= linked_functions[135].function_ptr;
	linked_functions[136].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConvexHullGetVertexData');
	NewtonConvexHullGetVertexData:= linked_functions[136].function_ptr;
	linked_functions[137].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConvexCollisionCalculateVolume');
	NewtonConvexCollisionCalculateVolume:= linked_functions[137].function_ptr;
	linked_functions[138].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConvexCollisionCalculateInertialMatrix');
	NewtonConvexCollisionCalculateInertialMatrix:= linked_functions[138].function_ptr;
	linked_functions[139].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConvexCollisionCalculateBuoyancyVolume');
	NewtonConvexCollisionCalculateBuoyancyVolume:= linked_functions[139].function_ptr;
	linked_functions[140].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionDataPointer');
	NewtonCollisionDataPointer:= linked_functions[140].function_ptr;
	linked_functions[141].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateCompoundCollision');
	NewtonCreateCompoundCollision:= linked_functions[141].function_ptr;
	linked_functions[142].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateCompoundCollisionFromMesh');
	NewtonCreateCompoundCollisionFromMesh:= linked_functions[142].function_ptr;
	linked_functions[143].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionBeginAddRemove');
	NewtonCompoundCollisionBeginAddRemove:= linked_functions[143].function_ptr;
	linked_functions[144].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionAddSubCollision');
	NewtonCompoundCollisionAddSubCollision:= linked_functions[144].function_ptr;
	linked_functions[145].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionRemoveSubCollision');
	NewtonCompoundCollisionRemoveSubCollision:= linked_functions[145].function_ptr;
	linked_functions[146].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionRemoveSubCollisionByIndex');
	NewtonCompoundCollisionRemoveSubCollisionByIndex:= linked_functions[146].function_ptr;
	linked_functions[147].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionSetSubCollisionMatrix');
	NewtonCompoundCollisionSetSubCollisionMatrix:= linked_functions[147].function_ptr;
	linked_functions[148].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionEndAddRemove');
	NewtonCompoundCollisionEndAddRemove:= linked_functions[148].function_ptr;
	linked_functions[149].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionGetFirstNode');
	NewtonCompoundCollisionGetFirstNode:= linked_functions[149].function_ptr;
	linked_functions[150].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionGetNextNode');
	NewtonCompoundCollisionGetNextNode:= linked_functions[150].function_ptr;
	linked_functions[151].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionGetNodeByIndex');
	NewtonCompoundCollisionGetNodeByIndex:= linked_functions[151].function_ptr;
	linked_functions[152].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionGetNodeIndex');
	NewtonCompoundCollisionGetNodeIndex:= linked_functions[152].function_ptr;
	linked_functions[153].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCompoundCollisionGetCollisionFromNode');
	NewtonCompoundCollisionGetCollisionFromNode:= linked_functions[153].function_ptr;
	linked_functions[154].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateFracturedCompoundCollision');
	NewtonCreateFracturedCompoundCollision:= linked_functions[154].function_ptr;
	linked_functions[155].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundPlaneClip');
	NewtonFracturedCompoundPlaneClip:= linked_functions[155].function_ptr;
	linked_functions[156].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundSetCallbacks');
	NewtonFracturedCompoundSetCallbacks:= linked_functions[156].function_ptr;
	linked_functions[157].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundIsNodeFreeToDetach');
	NewtonFracturedCompoundIsNodeFreeToDetach:= linked_functions[157].function_ptr;
	linked_functions[158].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundNeighborNodeList');
	NewtonFracturedCompoundNeighborNodeList:= linked_functions[158].function_ptr;
	linked_functions[159].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundGetMainMesh');
	NewtonFracturedCompoundGetMainMesh:= linked_functions[159].function_ptr;
	linked_functions[160].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundGetFirstSubMesh');
	NewtonFracturedCompoundGetFirstSubMesh:= linked_functions[160].function_ptr;
	linked_functions[161].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundGetNextSubMesh');
	NewtonFracturedCompoundGetNextSubMesh:= linked_functions[161].function_ptr;
	linked_functions[162].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundCollisionGetVertexCount');
	NewtonFracturedCompoundCollisionGetVertexCount:= linked_functions[162].function_ptr;
	linked_functions[163].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundCollisionGetVertexPositions');
	NewtonFracturedCompoundCollisionGetVertexPositions:= linked_functions[163].function_ptr;
	linked_functions[164].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundCollisionGetVertexNormals');
	NewtonFracturedCompoundCollisionGetVertexNormals:= linked_functions[164].function_ptr;
	linked_functions[165].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundCollisionGetVertexUVs');
	NewtonFracturedCompoundCollisionGetVertexUVs:= linked_functions[165].function_ptr;
	linked_functions[166].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundMeshPartGetIndexStream');
	NewtonFracturedCompoundMeshPartGetIndexStream:= linked_functions[166].function_ptr;
	linked_functions[167].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundMeshPartGetFirstSegment');
	NewtonFracturedCompoundMeshPartGetFirstSegment:= linked_functions[167].function_ptr;
	linked_functions[168].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundMeshPartGetNextSegment');
	NewtonFracturedCompoundMeshPartGetNextSegment:= linked_functions[168].function_ptr;
	linked_functions[169].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundMeshPartGetMaterial');
	NewtonFracturedCompoundMeshPartGetMaterial:= linked_functions[169].function_ptr;
	linked_functions[170].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonFracturedCompoundMeshPartGetIndexCount');
	NewtonFracturedCompoundMeshPartGetIndexCount:= linked_functions[170].function_ptr;
	linked_functions[171].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateSceneCollision');
	NewtonCreateSceneCollision:= linked_functions[171].function_ptr;
	linked_functions[172].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionBeginAddRemove');
	NewtonSceneCollisionBeginAddRemove:= linked_functions[172].function_ptr;
	linked_functions[173].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionAddSubCollision');
	NewtonSceneCollisionAddSubCollision:= linked_functions[173].function_ptr;
	linked_functions[174].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionRemoveSubCollision');
	NewtonSceneCollisionRemoveSubCollision:= linked_functions[174].function_ptr;
	linked_functions[175].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionRemoveSubCollisionByIndex');
	NewtonSceneCollisionRemoveSubCollisionByIndex:= linked_functions[175].function_ptr;
	linked_functions[176].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionSetSubCollisionMatrix');
	NewtonSceneCollisionSetSubCollisionMatrix:= linked_functions[176].function_ptr;
	linked_functions[177].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionEndAddRemove');
	NewtonSceneCollisionEndAddRemove:= linked_functions[177].function_ptr;
	linked_functions[178].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionGetFirstNode');
	NewtonSceneCollisionGetFirstNode:= linked_functions[178].function_ptr;
	linked_functions[179].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionGetNextNode');
	NewtonSceneCollisionGetNextNode:= linked_functions[179].function_ptr;
	linked_functions[180].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionGetNodeByIndex');
	NewtonSceneCollisionGetNodeByIndex:= linked_functions[180].function_ptr;
	linked_functions[181].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionGetNodeIndex');
	NewtonSceneCollisionGetNodeIndex:= linked_functions[181].function_ptr;
	linked_functions[182].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSceneCollisionGetCollisionFromNode');
	NewtonSceneCollisionGetCollisionFromNode:= linked_functions[182].function_ptr;
	linked_functions[183].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateUserMeshCollision');
	NewtonCreateUserMeshCollision:= linked_functions[183].function_ptr;
	linked_functions[184].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserMeshCollisionContinuousOverlapTest');
	NewtonUserMeshCollisionContinuousOverlapTest:= linked_functions[184].function_ptr;
	linked_functions[185].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateCollisionFromSerialization');
	NewtonCreateCollisionFromSerialization:= linked_functions[185].function_ptr;
	linked_functions[186].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSerialize');
	NewtonCollisionSerialize:= linked_functions[186].function_ptr;
	linked_functions[187].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetInfo');
	NewtonCollisionGetInfo:= linked_functions[187].function_ptr;
	linked_functions[188].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateHeightFieldCollision');
	NewtonCreateHeightFieldCollision:= linked_functions[188].function_ptr;
	linked_functions[189].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonHeightFieldSetUserRayCastCallback');
	NewtonHeightFieldSetUserRayCastCallback:= linked_functions[189].function_ptr;
	linked_functions[190].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateTreeCollision');
	NewtonCreateTreeCollision:= linked_functions[190].function_ptr;
	linked_functions[191].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateTreeCollisionFromMesh');
	NewtonCreateTreeCollisionFromMesh:= linked_functions[191].function_ptr;
	linked_functions[192].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonTreeCollisionSetUserRayCastCallback');
	NewtonTreeCollisionSetUserRayCastCallback:= linked_functions[192].function_ptr;
	linked_functions[193].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonTreeCollisionBeginBuild');
	NewtonTreeCollisionBeginBuild:= linked_functions[193].function_ptr;
	linked_functions[194].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonTreeCollisionAddFace');
	NewtonTreeCollisionAddFace:= linked_functions[194].function_ptr;
	linked_functions[195].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonTreeCollisionEndBuild');
	NewtonTreeCollisionEndBuild:= linked_functions[195].function_ptr;
	linked_functions[196].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonTreeCollisionGetFaceAttribute');
	NewtonTreeCollisionGetFaceAttribute:= linked_functions[196].function_ptr;
	linked_functions[197].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonTreeCollisionSetFaceAttribute');
	NewtonTreeCollisionSetFaceAttribute:= linked_functions[197].function_ptr;
	linked_functions[198].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonTreeCollisionForEachFace');
	NewtonTreeCollisionForEachFace:= linked_functions[198].function_ptr;
	linked_functions[199].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonTreeCollisionGetVertexListTriangleListInAABB');
	NewtonTreeCollisionGetVertexListTriangleListInAABB:= linked_functions[199].function_ptr;
	linked_functions[200].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonStaticCollisionSetDebugCallback');
	NewtonStaticCollisionSetDebugCallback:= linked_functions[200].function_ptr;
	linked_functions[201].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionCreateInstance');
	NewtonCollisionCreateInstance:= linked_functions[201].function_ptr;
	linked_functions[202].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetType');
	NewtonCollisionGetType:= linked_functions[202].function_ptr;
	linked_functions[203].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionIsConvexShape');
	NewtonCollisionIsConvexShape:= linked_functions[203].function_ptr;
	linked_functions[204].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionIsStaticShape');
	NewtonCollisionIsStaticShape:= linked_functions[204].function_ptr;
	linked_functions[205].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSetUserData');
	NewtonCollisionSetUserData:= linked_functions[205].function_ptr;
	linked_functions[206].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetUserData');
	NewtonCollisionGetUserData:= linked_functions[206].function_ptr;
	linked_functions[207].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSetUserID');
	NewtonCollisionSetUserID:= linked_functions[207].function_ptr;
	linked_functions[208].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetUserID');
	NewtonCollisionGetUserID:= linked_functions[208].function_ptr;
	linked_functions[209].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetMaterial');
	NewtonCollisionGetMaterial:= linked_functions[209].function_ptr;
	linked_functions[210].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSetMaterial');
	NewtonCollisionSetMaterial:= linked_functions[210].function_ptr;
	linked_functions[211].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetSubCollisionHandle');
	NewtonCollisionGetSubCollisionHandle:= linked_functions[211].function_ptr;
	linked_functions[212].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetParentInstance');
	NewtonCollisionGetParentInstance:= linked_functions[212].function_ptr;
	linked_functions[213].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSetMatrix');
	NewtonCollisionSetMatrix:= linked_functions[213].function_ptr;
	linked_functions[214].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetMatrix');
	NewtonCollisionGetMatrix:= linked_functions[214].function_ptr;
	linked_functions[215].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSetScale');
	NewtonCollisionSetScale:= linked_functions[215].function_ptr;
	linked_functions[216].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetScale');
	NewtonCollisionGetScale:= linked_functions[216].function_ptr;
	linked_functions[217].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDestroyCollision');
	NewtonDestroyCollision:= linked_functions[217].function_ptr;
	linked_functions[218].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionGetSkinThickness');
	NewtonCollisionGetSkinThickness:= linked_functions[218].function_ptr;
	linked_functions[219].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSetSkinThickness');
	NewtonCollisionSetSkinThickness:= linked_functions[219].function_ptr;
	linked_functions[220].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionIntersectionTest');
	NewtonCollisionIntersectionTest:= linked_functions[220].function_ptr;
	linked_functions[221].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionPointDistance');
	NewtonCollisionPointDistance:= linked_functions[221].function_ptr;
	linked_functions[222].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionClosestPoint');
	NewtonCollisionClosestPoint:= linked_functions[222].function_ptr;
	linked_functions[223].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionCollide');
	NewtonCollisionCollide:= linked_functions[223].function_ptr;
	linked_functions[224].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionCollideContinue');
	NewtonCollisionCollideContinue:= linked_functions[224].function_ptr;
	linked_functions[225].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionSupportVertex');
	NewtonCollisionSupportVertex:= linked_functions[225].function_ptr;
	linked_functions[226].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionRayCast');
	NewtonCollisionRayCast:= linked_functions[226].function_ptr;
	linked_functions[227].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionCalculateAABB');
	NewtonCollisionCalculateAABB:= linked_functions[227].function_ptr;
	linked_functions[228].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionForEachPolygonDo');
	NewtonCollisionForEachPolygonDo:= linked_functions[228].function_ptr;
	linked_functions[229].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionAggregateCreate');
	NewtonCollisionAggregateCreate:= linked_functions[229].function_ptr;
	linked_functions[230].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionAggregateDestroy');
	NewtonCollisionAggregateDestroy:= linked_functions[230].function_ptr;
	linked_functions[231].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionAggregateAddBody');
	NewtonCollisionAggregateAddBody:= linked_functions[231].function_ptr;
	linked_functions[232].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionAggregateRemoveBody');
	NewtonCollisionAggregateRemoveBody:= linked_functions[232].function_ptr;
	linked_functions[233].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionAggregateGetSelfCollision');
	NewtonCollisionAggregateGetSelfCollision:= linked_functions[233].function_ptr;
	linked_functions[234].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCollisionAggregateSetSelfCollision');
	NewtonCollisionAggregateSetSelfCollision:= linked_functions[234].function_ptr;
	linked_functions[235].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSetEulerAngle');
	NewtonSetEulerAngle:= linked_functions[235].function_ptr;
	linked_functions[236].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonGetEulerAngle');
	NewtonGetEulerAngle:= linked_functions[236].function_ptr;
	linked_functions[237].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCalculateSpringDamperAcceleration');
	NewtonCalculateSpringDamperAcceleration:= linked_functions[237].function_ptr;
	linked_functions[238].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateDynamicBody');
	NewtonCreateDynamicBody:= linked_functions[238].function_ptr;
	linked_functions[239].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateKinematicBody');
	NewtonCreateKinematicBody:= linked_functions[239].function_ptr;
	linked_functions[240].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateAsymetricDynamicBody');
	NewtonCreateAsymetricDynamicBody:= linked_functions[240].function_ptr;
	linked_functions[241].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDestroyBody');
	NewtonDestroyBody:= linked_functions[241].function_ptr;
	linked_functions[242].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetSimulationState');
	NewtonBodyGetSimulationState:= linked_functions[242].function_ptr;
	linked_functions[243].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetSimulationState');
	NewtonBodySetSimulationState:= linked_functions[243].function_ptr;
	linked_functions[244].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetType');
	NewtonBodyGetType:= linked_functions[244].function_ptr;
	linked_functions[245].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetCollidable');
	NewtonBodyGetCollidable:= linked_functions[245].function_ptr;
	linked_functions[246].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetCollidable');
	NewtonBodySetCollidable:= linked_functions[246].function_ptr;
	linked_functions[247].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyAddForce');
	NewtonBodyAddForce:= linked_functions[247].function_ptr;
	linked_functions[248].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyAddTorque');
	NewtonBodyAddTorque:= linked_functions[248].function_ptr;
	linked_functions[249].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetCentreOfMass');
	NewtonBodySetCentreOfMass:= linked_functions[249].function_ptr;
	linked_functions[250].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetMassMatrix');
	NewtonBodySetMassMatrix:= linked_functions[250].function_ptr;
	linked_functions[251].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetFullMassMatrix');
	NewtonBodySetFullMassMatrix:= linked_functions[251].function_ptr;
	linked_functions[252].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetMassProperties');
	NewtonBodySetMassProperties:= linked_functions[252].function_ptr;
	linked_functions[253].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetMatrix');
	NewtonBodySetMatrix:= linked_functions[253].function_ptr;
	linked_functions[254].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetMatrixNoSleep');
	NewtonBodySetMatrixNoSleep:= linked_functions[254].function_ptr;
	linked_functions[255].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetMatrixRecursive');
	NewtonBodySetMatrixRecursive:= linked_functions[255].function_ptr;
	linked_functions[256].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetMaterialGroupID');
	NewtonBodySetMaterialGroupID:= linked_functions[256].function_ptr;
	linked_functions[257].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetContinuousCollisionMode');
	NewtonBodySetContinuousCollisionMode:= linked_functions[257].function_ptr;
	linked_functions[258].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetJointRecursiveCollision');
	NewtonBodySetJointRecursiveCollision:= linked_functions[258].function_ptr;
	linked_functions[259].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetOmega');
	NewtonBodySetOmega:= linked_functions[259].function_ptr;
	linked_functions[260].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetOmegaNoSleep');
	NewtonBodySetOmegaNoSleep:= linked_functions[260].function_ptr;
	linked_functions[261].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetVelocity');
	NewtonBodySetVelocity:= linked_functions[261].function_ptr;
	linked_functions[262].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetVelocityNoSleep');
	NewtonBodySetVelocityNoSleep:= linked_functions[262].function_ptr;
	linked_functions[263].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetForce');
	NewtonBodySetForce:= linked_functions[263].function_ptr;
	linked_functions[264].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetTorque');
	NewtonBodySetTorque:= linked_functions[264].function_ptr;
	linked_functions[265].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetLinearDamping');
	NewtonBodySetLinearDamping:= linked_functions[265].function_ptr;
	linked_functions[266].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetAngularDamping');
	NewtonBodySetAngularDamping:= linked_functions[266].function_ptr;
	linked_functions[267].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetCollision');
	NewtonBodySetCollision:= linked_functions[267].function_ptr;
	linked_functions[268].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetCollisionScale');
	NewtonBodySetCollisionScale:= linked_functions[268].function_ptr;
	linked_functions[269].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetSleepState');
	NewtonBodyGetSleepState:= linked_functions[269].function_ptr;
	linked_functions[270].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetSleepState');
	NewtonBodySetSleepState:= linked_functions[270].function_ptr;
	linked_functions[271].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetAutoSleep');
	NewtonBodyGetAutoSleep:= linked_functions[271].function_ptr;
	linked_functions[272].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetAutoSleep');
	NewtonBodySetAutoSleep:= linked_functions[272].function_ptr;
	linked_functions[273].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetFreezeState');
	NewtonBodyGetFreezeState:= linked_functions[273].function_ptr;
	linked_functions[274].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetFreezeState');
	NewtonBodySetFreezeState:= linked_functions[274].function_ptr;
	linked_functions[275].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetGyroscopicTorque');
	NewtonBodyGetGyroscopicTorque:= linked_functions[275].function_ptr;
	linked_functions[276].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetGyroscopicTorque');
	NewtonBodySetGyroscopicTorque:= linked_functions[276].function_ptr;
	linked_functions[277].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetDestructorCallback');
	NewtonBodySetDestructorCallback:= linked_functions[277].function_ptr;
	linked_functions[278].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetDestructorCallback');
	NewtonBodyGetDestructorCallback:= linked_functions[278].function_ptr;
	linked_functions[279].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetTransformCallback');
	NewtonBodySetTransformCallback:= linked_functions[279].function_ptr;
	linked_functions[280].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetTransformCallback');
	NewtonBodyGetTransformCallback:= linked_functions[280].function_ptr;
	linked_functions[281].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetForceAndTorqueCallback');
	NewtonBodySetForceAndTorqueCallback:= linked_functions[281].function_ptr;
	linked_functions[282].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetForceAndTorqueCallback');
	NewtonBodyGetForceAndTorqueCallback:= linked_functions[282].function_ptr;
	linked_functions[283].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetID');
	NewtonBodyGetID:= linked_functions[283].function_ptr;
	linked_functions[284].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodySetUserData');
	NewtonBodySetUserData:= linked_functions[284].function_ptr;
	linked_functions[285].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetUserData');
	NewtonBodyGetUserData:= linked_functions[285].function_ptr;
	linked_functions[286].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetWorld');
	NewtonBodyGetWorld:= linked_functions[286].function_ptr;
	linked_functions[287].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetCollision');
	NewtonBodyGetCollision:= linked_functions[287].function_ptr;
	linked_functions[288].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetMaterialGroupID');
	NewtonBodyGetMaterialGroupID:= linked_functions[288].function_ptr;
	linked_functions[289].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetSerializedID');
	NewtonBodyGetSerializedID:= linked_functions[289].function_ptr;
	linked_functions[290].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetContinuousCollisionMode');
	NewtonBodyGetContinuousCollisionMode:= linked_functions[290].function_ptr;
	linked_functions[291].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetJointRecursiveCollision');
	NewtonBodyGetJointRecursiveCollision:= linked_functions[291].function_ptr;
	linked_functions[292].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetPosition');
	NewtonBodyGetPosition:= linked_functions[292].function_ptr;
	linked_functions[293].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetMatrix');
	NewtonBodyGetMatrix:= linked_functions[293].function_ptr;
	linked_functions[294].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetRotation');
	NewtonBodyGetRotation:= linked_functions[294].function_ptr;
	linked_functions[295].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetMass');
	NewtonBodyGetMass:= linked_functions[295].function_ptr;
	linked_functions[296].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetInvMass');
	NewtonBodyGetInvMass:= linked_functions[296].function_ptr;
	linked_functions[297].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetInertiaMatrix');
	NewtonBodyGetInertiaMatrix:= linked_functions[297].function_ptr;
	linked_functions[298].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetInvInertiaMatrix');
	NewtonBodyGetInvInertiaMatrix:= linked_functions[298].function_ptr;
	linked_functions[299].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetOmega');
	NewtonBodyGetOmega:= linked_functions[299].function_ptr;
	linked_functions[300].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetVelocity');
	NewtonBodyGetVelocity:= linked_functions[300].function_ptr;
	linked_functions[301].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetAlpha');
	NewtonBodyGetAlpha:= linked_functions[301].function_ptr;
	linked_functions[302].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetAcceleration');
	NewtonBodyGetAcceleration:= linked_functions[302].function_ptr;
	linked_functions[303].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetForce');
	NewtonBodyGetForce:= linked_functions[303].function_ptr;
	linked_functions[304].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetTorque');
	NewtonBodyGetTorque:= linked_functions[304].function_ptr;
	linked_functions[305].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetCentreOfMass');
	NewtonBodyGetCentreOfMass:= linked_functions[305].function_ptr;
	linked_functions[306].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetPointVelocity');
	NewtonBodyGetPointVelocity:= linked_functions[306].function_ptr;
	linked_functions[307].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyApplyImpulsePair');
	NewtonBodyApplyImpulsePair:= linked_functions[307].function_ptr;
	linked_functions[308].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyAddImpulse');
	NewtonBodyAddImpulse:= linked_functions[308].function_ptr;
	linked_functions[309].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyApplyImpulseArray');
	NewtonBodyApplyImpulseArray:= linked_functions[309].function_ptr;
	linked_functions[310].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyIntegrateVelocity');
	NewtonBodyIntegrateVelocity:= linked_functions[310].function_ptr;
	linked_functions[311].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetLinearDamping');
	NewtonBodyGetLinearDamping:= linked_functions[311].function_ptr;
	linked_functions[312].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetAngularDamping');
	NewtonBodyGetAngularDamping:= linked_functions[312].function_ptr;
	linked_functions[313].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetAABB');
	NewtonBodyGetAABB:= linked_functions[313].function_ptr;
	linked_functions[314].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetFirstJoint');
	NewtonBodyGetFirstJoint:= linked_functions[314].function_ptr;
	linked_functions[315].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetNextJoint');
	NewtonBodyGetNextJoint:= linked_functions[315].function_ptr;
	linked_functions[316].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetFirstContactJoint');
	NewtonBodyGetFirstContactJoint:= linked_functions[316].function_ptr;
	linked_functions[317].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyGetNextContactJoint');
	NewtonBodyGetNextContactJoint:= linked_functions[317].function_ptr;
	linked_functions[318].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBodyFindContact');
	NewtonBodyFindContact:= linked_functions[318].function_ptr;
	linked_functions[319].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactJointGetFirstContact');
	NewtonContactJointGetFirstContact:= linked_functions[319].function_ptr;
	linked_functions[320].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactJointGetNextContact');
	NewtonContactJointGetNextContact:= linked_functions[320].function_ptr;
	linked_functions[321].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactJointGetContactCount');
	NewtonContactJointGetContactCount:= linked_functions[321].function_ptr;
	linked_functions[322].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactJointRemoveContact');
	NewtonContactJointRemoveContact:= linked_functions[322].function_ptr;
	linked_functions[323].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactJointGetClosestDistance');
	NewtonContactJointGetClosestDistance:= linked_functions[323].function_ptr;
	linked_functions[324].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactJointResetSelftJointCollision');
	NewtonContactJointResetSelftJointCollision:= linked_functions[324].function_ptr;
	linked_functions[325].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactJointResetIntraJointCollision');
	NewtonContactJointResetIntraJointCollision:= linked_functions[325].function_ptr;
	linked_functions[326].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactGetMaterial');
	NewtonContactGetMaterial:= linked_functions[326].function_ptr;
	linked_functions[327].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactGetCollision0');
	NewtonContactGetCollision0:= linked_functions[327].function_ptr;
	linked_functions[328].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactGetCollision1');
	NewtonContactGetCollision1:= linked_functions[328].function_ptr;
	linked_functions[329].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactGetCollisionID0');
	NewtonContactGetCollisionID0:= linked_functions[329].function_ptr;
	linked_functions[330].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonContactGetCollisionID1');
	NewtonContactGetCollisionID1:= linked_functions[330].function_ptr;
	linked_functions[331].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointGetUserData');
	NewtonJointGetUserData:= linked_functions[331].function_ptr;
	linked_functions[332].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointSetUserData');
	NewtonJointSetUserData:= linked_functions[332].function_ptr;
	linked_functions[333].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointGetBody0');
	NewtonJointGetBody0:= linked_functions[333].function_ptr;
	linked_functions[334].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointGetBody1');
	NewtonJointGetBody1:= linked_functions[334].function_ptr;
	linked_functions[335].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointGetInfo');
	NewtonJointGetInfo:= linked_functions[335].function_ptr;
	linked_functions[336].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointGetCollisionState');
	NewtonJointGetCollisionState:= linked_functions[336].function_ptr;
	linked_functions[337].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointSetCollisionState');
	NewtonJointSetCollisionState:= linked_functions[337].function_ptr;
	linked_functions[338].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointGetStiffness');
	NewtonJointGetStiffness:= linked_functions[338].function_ptr;
	linked_functions[339].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointSetStiffness');
	NewtonJointSetStiffness:= linked_functions[339].function_ptr;
	linked_functions[340].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDestroyJoint');
	NewtonDestroyJoint:= linked_functions[340].function_ptr;
	linked_functions[341].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointSetDestructor');
	NewtonJointSetDestructor:= linked_functions[341].function_ptr;
	linked_functions[342].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonJointIsActive');
	NewtonJointIsActive:= linked_functions[342].function_ptr;
	linked_functions[343].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateMassSpringDamperSystem');
	NewtonCreateMassSpringDamperSystem:= linked_functions[343].function_ptr;
	linked_functions[344].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCreateDeformableSolid');
	NewtonCreateDeformableSolid:= linked_functions[344].function_ptr;
	linked_functions[345].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDeformableMeshGetParticleCount');
	NewtonDeformableMeshGetParticleCount:= linked_functions[345].function_ptr;
	linked_functions[346].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDeformableMeshGetParticleStrideInBytes');
	NewtonDeformableMeshGetParticleStrideInBytes:= linked_functions[346].function_ptr;
	linked_functions[347].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonDeformableMeshGetParticleArray');
	NewtonDeformableMeshGetParticleArray:= linked_functions[347].function_ptr;
	linked_functions[348].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConstraintCreateBall');
	NewtonConstraintCreateBall:= linked_functions[348].function_ptr;
	linked_functions[349].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBallSetUserCallback');
	NewtonBallSetUserCallback:= linked_functions[349].function_ptr;
	linked_functions[350].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBallGetJointAngle');
	NewtonBallGetJointAngle:= linked_functions[350].function_ptr;
	linked_functions[351].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBallGetJointOmega');
	NewtonBallGetJointOmega:= linked_functions[351].function_ptr;
	linked_functions[352].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBallGetJointForce');
	NewtonBallGetJointForce:= linked_functions[352].function_ptr;
	linked_functions[353].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonBallSetConeLimits');
	NewtonBallSetConeLimits:= linked_functions[353].function_ptr;
	linked_functions[354].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConstraintCreateHinge');
	NewtonConstraintCreateHinge:= linked_functions[354].function_ptr;
	linked_functions[355].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonHingeSetUserCallback');
	NewtonHingeSetUserCallback:= linked_functions[355].function_ptr;
	linked_functions[356].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonHingeGetJointAngle');
	NewtonHingeGetJointAngle:= linked_functions[356].function_ptr;
	linked_functions[357].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonHingeGetJointOmega');
	NewtonHingeGetJointOmega:= linked_functions[357].function_ptr;
	linked_functions[358].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonHingeGetJointForce');
	NewtonHingeGetJointForce:= linked_functions[358].function_ptr;
	linked_functions[359].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonHingeCalculateStopAlpha');
	NewtonHingeCalculateStopAlpha:= linked_functions[359].function_ptr;
	linked_functions[360].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConstraintCreateSlider');
	NewtonConstraintCreateSlider:= linked_functions[360].function_ptr;
	linked_functions[361].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSliderSetUserCallback');
	NewtonSliderSetUserCallback:= linked_functions[361].function_ptr;
	linked_functions[362].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSliderGetJointPosit');
	NewtonSliderGetJointPosit:= linked_functions[362].function_ptr;
	linked_functions[363].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSliderGetJointVeloc');
	NewtonSliderGetJointVeloc:= linked_functions[363].function_ptr;
	linked_functions[364].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSliderGetJointForce');
	NewtonSliderGetJointForce:= linked_functions[364].function_ptr;
	linked_functions[365].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonSliderCalculateStopAccel');
	NewtonSliderCalculateStopAccel:= linked_functions[365].function_ptr;
	linked_functions[366].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConstraintCreateCorkscrew');
	NewtonConstraintCreateCorkscrew:= linked_functions[366].function_ptr;
	linked_functions[367].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCorkscrewSetUserCallback');
	NewtonCorkscrewSetUserCallback:= linked_functions[367].function_ptr;
	linked_functions[368].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCorkscrewGetJointPosit');
	NewtonCorkscrewGetJointPosit:= linked_functions[368].function_ptr;
	linked_functions[369].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCorkscrewGetJointAngle');
	NewtonCorkscrewGetJointAngle:= linked_functions[369].function_ptr;
	linked_functions[370].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCorkscrewGetJointVeloc');
	NewtonCorkscrewGetJointVeloc:= linked_functions[370].function_ptr;
	linked_functions[371].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCorkscrewGetJointOmega');
	NewtonCorkscrewGetJointOmega:= linked_functions[371].function_ptr;
	linked_functions[372].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCorkscrewGetJointForce');
	NewtonCorkscrewGetJointForce:= linked_functions[372].function_ptr;
	linked_functions[373].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCorkscrewCalculateStopAlpha');
	NewtonCorkscrewCalculateStopAlpha:= linked_functions[373].function_ptr;
	linked_functions[374].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonCorkscrewCalculateStopAccel');
	NewtonCorkscrewCalculateStopAccel:= linked_functions[374].function_ptr;
	linked_functions[375].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConstraintCreateUniversal');
	NewtonConstraintCreateUniversal:= linked_functions[375].function_ptr;
	linked_functions[376].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUniversalSetUserCallback');
	NewtonUniversalSetUserCallback:= linked_functions[376].function_ptr;
	linked_functions[377].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUniversalGetJointAngle0');
	NewtonUniversalGetJointAngle0:= linked_functions[377].function_ptr;
	linked_functions[378].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUniversalGetJointAngle1');
	NewtonUniversalGetJointAngle1:= linked_functions[378].function_ptr;
	linked_functions[379].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUniversalGetJointOmega0');
	NewtonUniversalGetJointOmega0:= linked_functions[379].function_ptr;
	linked_functions[380].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUniversalGetJointOmega1');
	NewtonUniversalGetJointOmega1:= linked_functions[380].function_ptr;
	linked_functions[381].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUniversalGetJointForce');
	NewtonUniversalGetJointForce:= linked_functions[381].function_ptr;
	linked_functions[382].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUniversalCalculateStopAlpha0');
	NewtonUniversalCalculateStopAlpha0:= linked_functions[382].function_ptr;
	linked_functions[383].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUniversalCalculateStopAlpha1');
	NewtonUniversalCalculateStopAlpha1:= linked_functions[383].function_ptr;
	linked_functions[384].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConstraintCreateUpVector');
	NewtonConstraintCreateUpVector:= linked_functions[384].function_ptr;
	linked_functions[385].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUpVectorGetPin');
	NewtonUpVectorGetPin:= linked_functions[385].function_ptr;
	linked_functions[386].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUpVectorSetPin');
	NewtonUpVectorSetPin:= linked_functions[386].function_ptr;
	linked_functions[387].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonConstraintCreateUserJoint');
	NewtonConstraintCreateUserJoint:= linked_functions[387].function_ptr;
	linked_functions[388].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointGetSolverModel');
	NewtonUserJointGetSolverModel:= linked_functions[388].function_ptr;
	linked_functions[389].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointSetSolverModel');
	NewtonUserJointSetSolverModel:= linked_functions[389].function_ptr;
	linked_functions[390].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointMassScale');
	NewtonUserJointMassScale:= linked_functions[390].function_ptr;
	linked_functions[391].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointSetFeedbackCollectorCallback');
	NewtonUserJointSetFeedbackCollectorCallback:= linked_functions[391].function_ptr;
	linked_functions[392].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointAddLinearRow');
	NewtonUserJointAddLinearRow:= linked_functions[392].function_ptr;
	linked_functions[393].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointAddAngularRow');
	NewtonUserJointAddAngularRow:= linked_functions[393].function_ptr;
	linked_functions[394].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointAddGeneralRow');
	NewtonUserJointAddGeneralRow:= linked_functions[394].function_ptr;
	linked_functions[395].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointSetRowMinimumFriction');
	NewtonUserJointSetRowMinimumFriction:= linked_functions[395].function_ptr;
	linked_functions[396].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointSetRowMaximumFriction');
	NewtonUserJointSetRowMaximumFriction:= linked_functions[396].function_ptr;
	linked_functions[397].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointCalculateRowZeroAcceleration');
	NewtonUserJointCalculateRowZeroAcceleration:= linked_functions[397].function_ptr;
	linked_functions[398].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointGetRowAcceleration');
	NewtonUserJointGetRowAcceleration:= linked_functions[398].function_ptr;
	linked_functions[399].function_ptr := dynlibs.GetProcAddress(NewtonLibrary, 'NewtonUserJointGetRowJacobian');
